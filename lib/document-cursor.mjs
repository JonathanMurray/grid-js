export class DocumentWithCursor {
    ...
    cursorRightWord() {
        ...
        if (this.cursorChar < line.length) {
            this.cursorChar ++;
            for (; this.cursorChar < line.length; this.cursorChar ++) {
                if (this.cursorChar < line.length && line[this.cursorChar] !== " " && line[this.cursorChar + 1] === " ") {
                    this.cursorChar ++;
                    break;
                }
            }
    ...
    cursorLeftWord() {
        if (this.cursorChar > 0) {
            const line = this.lines[this.cursorLine];
            this.cursorChar --;
            for (; this.cursorChar > 0; this.cursorChar --) {
                if (this.cursorChar > 0 && line[this.cursorChar] !== " " && line[this.cursorChar - 1] === " ") {
                    break;
                }
            }
        } else if (this.cursorLine > 0) {
