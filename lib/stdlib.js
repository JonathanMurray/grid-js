const stdlib = function() {
    ...
    const terminal = function() {
        ...
        async function enterAlternateScreen() {
            await writeCommand({enterAlternateScreen: null});
        }

        async function exitAlternateScreen() {
            await writeCommand({exitAlternateScreen: null});
        }
        ...
        return {clear, setTextStyle, setBackgroundStyle, writeCommand, enterAlternateScreen, exitAlternateScreen};
    } ();
    ...
    return {createWindow, terminal, write, writeln, read, readln, log};
