...
export async function setupGraphics() {
    return await syscall("graphics");
}

export async function createWindow(title, size, options, args) {
    ...
    const {socketFd, canvas} = await syscall("graphics", {title, size, resizable, menubarItems});
